...
{
    public partial class AdminFaqJ : System.Web.UI.Page
    {
        ...
        {
            lblMsg.Text = "";
            //lblMsg.Text = ddlcat.SelectedItem.Text.ToString();
            ...
            //cmd.CommandText = "select * from tblFaq where faq_question=@Faq";
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            //cmd.Parameters.AddWithValue("@Faq_cat", ddlcat.SelectedValue.ToString());
            //cmd.Parameters.AddWithValue("@Faq", txtques.Text);
