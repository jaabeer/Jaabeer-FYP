<%@ Page Title="" Language="C#" MasterPageFile="~/AdminJs.Master" AutoEventWireup="true" CodeBehind="HotelCreation.aspx.cs" Inherits="DealProjectTamam.Admin2.HotelCreation" %>
    ...
    <ajaxToolkit:Accordion ID="Accord_create_villa" runat="server" SelectedIndex="0"
        ...
        <Panes>
            ...
            <ajaxToolkit:AccordionPane ID="AccordionPane2" runat="server">
                <Header><a href="#" style="color: #000000">2. Enter Hotel Details</a></Header>
                <Content>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtProp_name" Display="Dynamic"
                                CssClass="text-danger" ErrorMessage="Property Name is required." ValidationGroup="VgHotelDetails" />
                        </div>
                        <div class="col-sm-6">
                            <asp:Label runat="server" AssociatedControlID="txtProp_phone" Display="Dynamic" ForeColor="Black"> Hotel Contact</asp:Label>
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtProp_phone" Display="Dynamic" ForeColor="Black"
                                CssClass="text-danger" ErrorMessage="Property Phone Number is required." ValidationGroup="VgHotelDetails" />
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <asp:Label runat="server" AssociatedControlID="txtProp_priceday" Display="Dynamic" ForeColor="Black">Hotel Price </asp:Label>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <asp:Button ID="btnCancel" runat="server"
                                Text="Cancel" OnClick="btnCancel_Click" CausesValidation="false" ValidationGroup="VgHotelDetails"
            ...
            <ajaxToolkit:AccordionPane ID="AccordionPane4" runat="server">
                <Header><a href="#" style="color: #000000">4. Specify number of Bedrooms, size and related information</a></Header>
                <Content>

                    <br />
                    <h4>Particulars of Hotel.</h4>
                    <hr />
                                    ...
                                    <tr>
                                        <td>
                                            <asp:DropDownList runat="server" ID="ddlDet_name" Display="Dynamic">
                                                <asp:ListItem Value="-1">Select particular</asp:ListItem>
                                            </asp:DropDownList>
                                ...
                                <asp:GridView ID="gvs_3" OnSelectedIndexChanged="gvs_3_SelectedIndexChanged" DataKeyNames="Fac_id" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Villa's Facilities">
                                            <ItemTemplate>
                                                <!-- display the category name -->
                                                <asp:Label ID="lblDet_name" Text='<%#Eval("Rooms_Fac_name")%>'
                                                    runat="server" Font-Size="Medium" Font-Bold="True" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
            ...
            <ajaxToolkit:AccordionPane ID="AccordionPane6" runat="server">
                <Header><a href="#" style="color: #000000">6. Activate Hotel and Notify Owner.</a></Header>
                <Content>
