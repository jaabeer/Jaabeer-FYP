...
{
    public partial class AdminDistrictJ : System.Web.UI.Page
    {
        ...
        protected void gvs_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //Cat_name_old = ((Label)gvs.SelectedRow.FindControl("lblCatName")).Text;
            //Cat_Desc_old = ((Label)gvs.SelectedRow.FindControl("lblCatDes")).Text;
        }
