<%@ Page Title="Support Requests" Language="C#" MasterPageFile="~/AdminJs.Master" AutoEventWireup="true" CodeBehind="Newsupport.aspx.cs" Inherits="DealProjectTamam.Admin2.Newsupport" %>
            ...
            <asp:TemplateField HeaderText="Action">
                <ItemTemplate>
                    <asp:LinkButton ID="lnkblock" CssClass="btn-view"
                        runat="server" 
                        Text="View Details"
                        PostBackUrl='<%# Eval("id", "New_sup_details.aspx?ID={0}") %>'></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
