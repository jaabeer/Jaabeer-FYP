...
{
    public partial class AdminRoomtypeJ : System.Web.UI.Page
    {
        ...
        private void BindCategoryData()
        {
            ...
            cmd.CommandText = "SELECT * FROM tblRoom_type";
        ...
        protected void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from tblRoom_type where Rmtype_name=@Rmtype_name";
            //Create a parametererized query for CatID
            cmd.Parameters.AddWithValue("@Rmtype_name", Fac_name);
            ...
            using (da)
            {
                ...
                else
                {
                    ...
                    //Add DELETE statement to delete the selected category for the above CatID
                    cmd2.CommandText = "insert into tblRoom_type ([Rmtype_name]) values (@Rmtype_name)";
                    //Create a parametererized query for CatID
                    cmd2.Parameters.AddWithValue("@Rmtype_name", Fac_name);
                    con2.Open();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd0.CommandText = "select * from tblRoom_type where Rmtype_id=@Rmtype_id";
                //Create a parametererized query for CatID
                cmd0.Parameters.AddWithValue("@Rmtype_id", Fac_id);
                ...
                using (da0)
                {
                    ...
                    if (dt0.Rows.Count > 0)
                    {
                        Fac_name_old = dt0.Rows[0]["Rmtype_name"].ToString();
                    }
                ...
                else
                {
                    ...
                    //Add DELETE statement to delete the selected category for the above CatID
                    cmd3.CommandText = "select * from tblRoom_type where Rmtype_name=@Rmtype_name";

                    cmd3.Parameters.AddWithValue("@Rmtype_name", Fac_name);
                    ...
                    using (da)
                    {
                        ...
                        else
                        {
                            ...
                            //Add DELETE statement to delete the selected category for the above CatID
                            cmd4.CommandText = "update tblRoom_type set Rmtype_name=@Rmtype_name where Rmtype_id=@Rmtype_id";

                            cmd4.Parameters.AddWithValue("@Rmtype_name", Fac_name);
                            cmd4.Parameters.AddWithValue("@Rmtype_id", Fac_id);
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd2.CommandText = "delete from tblRoom_type where Rmtype_id=@Rmtype_id";
                cmd2.Parameters.AddWithValue("@Rmtype_id", Fac_id);
                cmd2.Connection = con2;
                con2.Open();
                ...
                if (IsDeleted)
                {
                    lblMsg.Text = Fac_name + " rmtype deleted successfully!";
                    lblMsg.ForeColor = System.Drawing.Color.Green;
                    //Refresh the GridView by calling the BindCategoryData()
                    BindCategoryData();
                }
                ...
                {
                    lblMsg.Text = "Error while deleting " + Fac_name + " Room_Type";
                    lblMsg.ForeColor = System.Drawing.Color.Red;
                }
                ResetAll();
