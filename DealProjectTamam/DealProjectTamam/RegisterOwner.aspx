<%@ Page Title="" Language="C#" MasterPageFile="~/DealTamam2.Master" AutoEventWireup="true" CodeBehind="RegisterOwner.aspx.cs" Inherits="DealProjectTamam.RegisterOwner" %>
                ...
                <div class="col-md-9">
                    ...
                    <fieldset>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <asp:RangeValidator ID="rvdob" runat="server"
                                    ...
                                    Text="Out of Range, You should be 18 to 90 years old" CssClass="text-danger"
                                    ErrorMessage="You should be 18 to 90 years old" Display="Dynamic" />
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <asp:Label runat="server" AssociatedControlID="txtOfficeNo" Display="Dynamic">Office Number</asp:Label>
                                <asp:TextBox runat="server" ID="txtOfficeNo" CssClass="form-control" />
                                <asp:CustomValidator ID="cv_office_no" ControlToValidate="txtOfficeNo" CssClass="text-danger" Text="(Office Phone must contain 7 numbers)"
                                    ClientValidationFunction="val_office_number"
                                    runat="server" />
                            </div>
                        </div>
