<%@ Page Title="" Language="C#" MasterPageFile="~/Owner2Master.Master" AutoEventWireup="true" CodeBehind="ViewBooking1.aspx.cs" Inherits="DealProjectTamam.ViewBooking1" %>
        ...
        <asp:GridView ID="gvs" CssClass="table table-striped table-bordered align-items-center"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Reference" HeaderStyle-BackColor="#009999" HeaderStyle-Width="10%">
                    <ItemTemplate>
                        <h5><asp:HyperLink runat="server" NavigateUrl='<%# "ViewBookingDetails1.aspx?ID="+ Eval("Bk_id") %>' Text='<%# Eval("Bk_ref") %>'> </asp:HyperLink></h5>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Justify"></ItemStyle>
                </asp:TemplateField>
