<%@ Page Title="" Language="C#" MasterPageFile="~/Client1.Master" AutoEventWireup="true" CodeBehind="Hotel_details.aspx.cs" Inherits="DealProjectTamam.Hotel_details" %>
...
.room-information .row .first {
    font-weight: bold;
}

.room-information .row .second {
    color: #f97d09;
}
...
.room-information .gradient-button:hover {
    background-color: #ca5e07;
}
        ...
        <div class="wrap">
            <div class="row">
                <section class="three-fourth">
                    ...
                    <div class="gallery">
                        <ul id="image-gallery" class="cS-hidden">
                            <asp:Repeater ID="Repeater1" runat="server">
                                <ItemTemplate>
                                    <li data-thumb="">
                                        <asp:Image ID="Image1" runat="server" ImageUrl='<%# "~/Property/" + Eval("Hotel_id") + "/" + Eval("Img_name") %>' alt="" />
                                    </li>
                                </ItemTemplate>
                            </asp:Repeater>
                        </ul>
                    ...
                    <br />
                    <br />
                    <section id="Hotel availability" class="tab-content">
                        <article>
                            <h2>Availability</h2>
                            <div class="text-wrap">
...
<div class="room-information">
    <div class="row">
        ...
        <span class="second"><asp:Label ID="lbl_min" runat="server" Text="1 day"></asp:Label></span>
    </div>
    <div class="row">
    ...
    <div class="row">
        <span class="first">Total Price:</span>
        <span class="second">Rs.<asp:Label ID="lbl_total" runat="server"></asp:Label></span>
    </div>
    <div class="button-wrapper">
        <asp:Button ID="btn_daily" runat="server" Text="Book now" CssClass="gradient-button" OnClick="btn_booking_Click" />
    </div>
</div>
                    ...
                    <section id="reviews" class="tab-content">
                        <article>
                            <h2>Hotel Rating and Reviews</h2>
                            <div class="score">
                            ...
                            <div>
                                <p class="disclaimer"> reviews are written by our customers after their stay at
 ...
 <script type="text/javascript">
     ...
     document.getElementById("txtcheckin").addEventListener("change", calculateTotalPrice);
     document.getElementById("txtcheckout").addEventListener("change", calculateTotalPrice);

     function calculateTotalPrice() {
         let checkinDate = new Date(document.getElementById("txtcheckin").value);
         let checkoutDate = new Date(document.getElementById("txtcheckout").value);
         if (checkinDate && checkoutDate && checkinDate < checkoutDate) {
             let timeDifference = Math.abs(checkoutDate - checkinDate);
             let dayDifference = Math.ceil(timeDifference / (1000 * 60 * 60 * 24));
             document.getElementById('<%= lbl_min.ClientID %>').textContent = dayDifference + " days";
             let pricePerDay = parseInt(document.getElementById('<%= lbl_day.ClientID %>').textContent);
             document.getElementById('<%= lbl_total.ClientID %>').textContent = dayDifference * pricePerDay;
         }
     }
