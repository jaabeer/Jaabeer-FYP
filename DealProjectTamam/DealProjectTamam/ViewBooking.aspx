<%@ Page Title="" Language="C#" MasterPageFile="~/Owner.Master" AutoEventWireup="true" CodeBehind="ViewBooking.aspx.cs" Inherits="DealProjectTamam.ViewBooking" %>
        ...
        <asp:GridView ID="gvs" CssClass="table table-striped table-bordered align-items-center"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Reference" HeaderStyle-BackColor="#009999" HeaderStyle-Width="10%">
                    <ItemTemplate>
                        <h5><asp:HyperLink runat="server" NavigateUrl='<%# "Viewbookingdetails.aspx?ID="+ Eval("Bk_id") %>' Text='<%# Eval("Bk_ref") %>'> </asp:HyperLink></h5>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Justify"></ItemStyle>
                </asp:TemplateField>
