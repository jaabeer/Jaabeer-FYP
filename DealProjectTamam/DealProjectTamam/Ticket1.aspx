<%@ Page Title="" Language="C#" MasterPageFile="~/Owner2Master.Master" AutoEventWireup="true" CodeBehind="Ticket1.aspx.cs" Inherits="DealProjectTamam.Ticket1" %>
    ...
    <div class="three-fourth">
					<div class="comments">
						...
						<div class="comment depth-0">
							...
							<asp:LinkButton ID="btnread" runat="server" CssClass="reply" PostBackUrl='<%# "Owner_ticket_details.aspx?Parameter="+ Eval("id") %>'  Text="More info" />
