...
{
    public partial class Active_Booking_Details1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["Page_name"] = "View_booking_details_ribbon";
        ...
        void fill_booking_details()
        {
            ...
            cmd.CommandText = "SELECT * from tblClient tc inner join tblBooking tb on tb.Client_id=tc.Client_id inner join tblVilla tv on tv.Villa_id=tb.Villa_id inner join tblDistrict td on td.Dist_id=tv.Dist_id where tb.Bk_id = " + qs;
            cmd.Connection = con;
            SqlDataReader dr;
            con.Open();
            ...
            while (dr.Read())
            {
                ...
                txt_prop_id.Text = dr["Villa_id"].ToString();
                ...
                txt_villa_name.Text = dr["Villa_name"].ToString();
                txt_villa_address.Text = dr["Villa_street"].ToString() + ", " + dr["Villa_town"].ToString() + ", " + dr["Dist_name"].ToString();
        ...
        void generate_pdf()
        {
           ...
           page.Paragraphs.Add(new Aspose.Pdf.Text.TextFragment("Deal Tamam BOOKING"));
            ...
            page.Paragraphs.Add(new Aspose.Pdf.Text.TextFragment(" "));
            page.Paragraphs.Add(new Aspose.Pdf.Text.TextFragment("First Name: " + txt_lname.Text.ToString()));
            page.Paragraphs.Add(new Aspose.Pdf.Text.TextFragment(" "));
            page.Paragraphs.Add(new Aspose.Pdf.Text.TextFragment("Last Name: " + txt_fname.Text.ToString()));
            page.Paragraphs.Add(new Aspose.Pdf.Text.TextFragment(" "));
        ...
        protected void btn_reject_Click(object sender, EventArgs e)
        {
            ...
            if (isDeleted)
            {
                ...
                SqlCommand cmd1 = new SqlCommand();
                cmd1.CommandType = CommandType.Text;
                cmd1.CommandText = "delete from tblNotification  where Notif_type='booking' and Villa_id=" + qs;
                ...
                if (IsUpdated1)
                {
                    ...
                    PrePurchaseMail();
                    lbl_message.Text = "Booking has been Reject";
        ...
        protected void PrePurchaseMail()
        {
            ...
            try
            {
                ...
                msgBody.Append("<br><hr>");
                msgBody.Append("<center><h5 style='background-color:powderblue;'>Copyright Deal Tamam Villa</h5></center>");
                msgBody.Append("</div>");
        ...
        {
            text_sms = "Hello Dear Client " + txt_lname.Text.Trim() + " " + txt_fname.Text.Trim() + ", we are happy to confirm your order  #" + txt_bk_ref.Text.Trim() + " for the Villa " + txt_villa_name.Text.Trim() + " from " + txt_check_in.Text.Trim() + " till " + txt_check_out.Text.Trim() + ". For Customer Service call on 2454590";
        }
        ...
        {
            text_sms = "Hello Client " + txt_lname.Text.Trim() + " " + txt_fname.Text.Trim() + ", your order  #" + txt_bk_ref.Text.Trim() + " for the Villa " + txt_villa_name + " from " + txt_check_in.Text.Trim() + " till " + txt_check_out.Text.Trim() + " has been rejected. Make a new booking or contact Customer Service call on 245 45 90";
        }
