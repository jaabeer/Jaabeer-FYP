<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSayf.Master" AutoEventWireup="true" CodeBehind="New_Support_Details.aspx.cs" Inherits="DealProjectTamam.AdminS.New_Support_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <center>
            <asp:LinkButton ID="Back" runat="server" Text="Back" PostBackUrl="~/AdminS/NewSupport.aspx" CssClass="btn" Font-Size="Large" Font-Bold="True" CausesValidation="false"></asp:LinkButton>
        </center>
    </div>
</asp:Content>