...
{
    public partial class New_vdetails : System.Web.UI.Page
    {
        ...
        void Populate_owner_loc_price()
        {
            ...
            cmd.CommandText = "SELECT * FROM tblVilla tv inner join tblDistrict td on td.Dist_id = tv.Dist_id inner join tblOwner tow on tow.Own_id = tv.Own_id where tv.Villa_id=@Villa_id";
            cmd.Parameters.AddWithValue("@Villa_id", prop_id);
            SqlDataReader dr;
            dbcon.Open();
            dr = cmd.ExecuteReader();
            while (dr.Read())
        ...
        void Populate_dlstImages()
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "SELECT * FROM tblImage where Villa_id = " + prop_id;
        ...
        void retrieve_and_store_old_values()
        {
            ...
            cmd.CommandText = "SELECT * FROM tblVilla tv inner join tblDistrict td on td.Dist_id = tv.Dist_id where tv.Villa_id = " + prop_id;
            SqlDataReader dr;
            dbcon.Open();
            dr = cmd.ExecuteReader();
            while (dr.Read())
        ...
        protected void lnkapprove_Click(object sender, EventArgs e)
        {
            ...
            cmd4.CommandText = "update tblVilla set Villa_status=@status where Villa_id=@Villa_id";

            cmd4.Parameters.AddWithValue("@Villa_id", txtProp_id.Text.Trim());
            ...
            if (IsUpdated)
            {
                ...
                cmd5.Parameters.AddWithValue("@Villa_id", txtProp_id.Text.Trim());
                cmd5.Parameters.AddWithValue("@status", 1);
                cmd5.Parameters.AddWithValue("@comment", "The Villa " + txtProp_name.Text.Trim() + " has been approved on " + DateTime.Today + ".");
                con5.Open();
                ...
                if (IsUpdated1)
                {
                    ...
                    sendMailApprove();
                    Response.Redirect("~/AdminS/New_villa.aspx");
                }

            }
            else
            {
                lblMsg.Text = "Error while  validating the Villa " + txtProp_name.Text.Trim();
        ...
        protected void sendMailApprove()
        {
            ...
            try
            {
                ...
                m.To.Add(email_add);
                m.Subject = "Villa Approval Confirmation";
                m.IsBodyHtml = true;
                StringBuilder msgBody = new StringBuilder();
                msgBody.Append("Dear " + Owner_name + ", <br/> The request to validate your Villa,  " + txtProp_name.Text.Trim() + " has been validated on the " + DateTime.Today + ".<br/> For any additional request, please contact the support team. <br/> Regards Deal Tamam ");
        ...
        protected void btnReject_Click(object sender, EventArgs e)
        {
            ...
            cmd5.Parameters.AddWithValue("@Villa_id", txtProp_id.Text.Trim());
            cmd5.Parameters.AddWithValue("@status", 1);
            cmd5.Parameters.AddWithValue("@comment", "The Villa " + txtProp_name.Text.Trim() + " has been reject on " + DateTime.Today + " as " + txtComment.Text.Trim());
            ...
            {
                lblMsg.Text = "Error while  rejecting the Villa " + txtProp_name.Text;
                lblMsg.ForeColor = System.Drawing.Color.Red;
        ...
        protected void sendMailReject()
        {
            ...
            try
            {
                m.From = new MailAddress("dealtamam02@gmail.com");
                m.To.Add(email_add);
                m.Subject = "Villa Rejection Confirmation";
                m.IsBodyHtml = true;
                StringBuilder msgBody = new StringBuilder();
                msgBody.Append("Dear " + Owner_name + ", <br/> The request to validate your Villa,  " + txtProp_name.Text.Trim() + " has been <b>rejected</b> on the " + DateTime.Today + ".<br/> For any additional request, please contact the support team. <br/> Regards Deal Tamam");
        ...
        protected void getVillaID()
        {
            ...
            cmd.CommandText = "select Villa_id  from tblNotification where id=" + qs;
            SqlDataReader dr;
            dbcon.Open();
            dr = cmd.ExecuteReader();
            while (dr.Read())
            {
                prop_id = dr["Villa_id"].ToString();
            }
        ...
        protected void text_msg_reject()
        {
            ...
            Sms_reject = "Dear " + Owner_name + ",  The request to validate your Villa,  " + txtProp_name.Text.Trim() + " has been rejected on the " + DateTime.Today + ". For any additional request, please contact the support team. <br/> Regards Deal Tamam";
        }

        protected void text_msg_approve()
        {

            Sms_approve = "Dear " + Owner_name + ",  The request to validate your Villa,  " + txtProp_name.Text.Trim() + " has been validated on the " + DateTime.Today + ". For any additional request, please contact the support team. <br/> Regards Deal Tamam";
        }
