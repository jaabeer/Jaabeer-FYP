...
{
    public partial class Notif_update_Villa : System.Web.UI.Page
    {
        ...
        void getVillas()
        {
            ...
            cmd.CommandText = "SELECT * from tblVilla tv, tblNotification tn, tblDistrict td where td.Dist_id= tv.Dist_id and  tn.Villa_id = tv.Villa_id and tn.State=0 and tn.Notif_type='update'";
            cmd.Connection = con;
