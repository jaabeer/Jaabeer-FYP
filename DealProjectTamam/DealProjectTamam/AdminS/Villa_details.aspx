<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSayf.Master" AutoEventWireup="true" CodeBehind="Villa_details.aspx.cs" Inherits="DealProjectTamam.AdminS.Villa_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="padding-left: 550px">
        <br />
        <asp:LinkButton ID="Back" runat="server" Text="Back" PostBackUrl="~/AdminS/Search_villa.aspx" CssClass="btn btn-info" Font-Size="Large" Font-Bold="True" CausesValidation="false"></asp:LinkButton>
    </div>
