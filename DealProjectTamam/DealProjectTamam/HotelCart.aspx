<%@ Page Title="" Language="C#" MasterPageFile="~/Client1.Master" AutoEventWireup="true" CodeBehind="HotelCart.aspx.cs" Inherits="DealProjectTamam.HotelCart" %>
    ...
    <div class="row">
		...
		<div class="three-fourth">
						...
						<div class="row deals  results">
							...
							<figure><a href="hotel.html" title=""><asp:Image ID="Image1" runat="server" ImageUrl='<%# "~/Property/" + Eval("Hotel_id") + "/main/" + Eval("Hotel_image") %>' width="300px" Height="200px" /></a></figure>
							<div class="details">
								<h3><%# Eval("Hotel_name")%>  <asp:LinkButton ID="lbtnview_booking" Text="View Villa" runat="server" PostBackUrl= '<%# "Hotel_details.aspx?Parameter="+ Eval("Hotel_id") %>'></asp:LinkButton>
								...
								<div class="description">
									<p style="text-overflow:ellipsis; overflow:hidden; white-space:nowrap;"> <%# Eval("Hotel_desc")%></p>
								</div>
				 ...
				 <aside class="one-fourth right-sidebar">
                    ...
                    <article class="widget">
                        ...
                        <p class="number">(+230) 245-45-45</p>
