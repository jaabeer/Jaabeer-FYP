...
namespace DealProjectTamam
{
    public partial class Booking_Details : System.Web.UI.Page
    {
        ...
        protected void profileData()
        {
            ...
            cmd.CommandText = "Select C.Client_fname, C.Client_lname, C.Client_email, C.Client_contact, V.Villa_name, V.Villa_town, B.Bk_checkin,  B.Bk_checkout,B.BK_amnt, B.Bk_type, B.Bk_srequest, V.Villa_id, B.Bk_ref from tblVilla V, tblClient C, tblBooking B Where v.Villa_id = B.Villa_id AND C.Client_id = B.Client_id AND b.Bk_id =@booking";
            SqlDataReader dr;
            con.Open();
            ...
            while (dr.Read())
            {
                ...
                txt_region.Text = dr["Villa_town"].ToString();
                ...
                txt_villa.Text = dr["Villa_name"].ToString();
        ...
        protected void cancel_Click(object sender, EventArgs e)
        {
            ...
            if (IsDeleted)
            {
                Response.Redirect("~/Client/cvilla_details.aspx?Parameter=" + villa_id);
            }
            else
            {
        ...
        protected void text_msg()
        {
            ...
            protected void PrePurchaseMsg(String text)
            {
            ...
            protected void addNotif()
            {
                ...
                cmd2.CommandText = "insert into tblNotification ([Notif_details], [Notif_type], [user_id], [Villa_id], [Notif_date], [State]) values (@details, @type, @user, @Villa, @date, @state)";
                ...
                cmd2.Parameters.AddWithValue("@Villa", booking);
