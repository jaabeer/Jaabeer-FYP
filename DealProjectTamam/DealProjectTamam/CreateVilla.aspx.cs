...
{
    public partial class CreateVilla : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            cmd2.CommandText = "SELECT * FROM tblVilla where Villa_name=@Villa_phone";
                ...
                (lblResult4.Text.Length == 0) && (lblResult5.Text.Length == 0) && (lblResult6.Text.Length == 0))
            {
                ...
                cmd4.Parameters.AddWithValue("@Villa_email", Session["owner_email"].ToString());
                ...
                if (IsAdded)
                {
                    ...
                    lblResult1.Text = "Villa created, You can now upload pictures, assign accessibilities and facilities";
        ...
        protected void Btn_Save_description_Click(object sender, EventArgs e)
        {
            ...
            if ((txt_Description.Text.ToString()).Length != 0)
            {
                ...
                if (IsUpdated)
                {
                    lbl_Prop_Desc.Text = "Villa Description Added";
        ...
        protected void BtnSendMail_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                message.To.Add(new MailAddress("dealtamam02@gmail.com")); 
                message.Subject = txtProp_name.Text + " Villa Approval Request";
                ...
                if (string.IsNullOrWhiteSpace(txtemail.Text))
                {
                    ...
                    msgBody.AppendLine("<br/>Could you please approve my new villa request?");
                ...
                client.Send(message);
                Response.Redirect("mailsent2.aspx"); 
            }
            catch (Exception ex)
            {
        ...
        protected void AddNotification()
        {
            ...
            cmd2.Parameters.AddWithValue("@Villa", txtProp_id.Text.ToString());
