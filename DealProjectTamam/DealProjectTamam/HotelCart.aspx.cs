...
{
    public partial class HotelCart : System.Web.UI.Page
    {
        ...
        protected void CartData()
        {
            ...
            cmd.CommandText = "SELECT * from tblBooking B, tblHotel H where B.Hotel_id=H.Hotel_id and Bk_state='P' and Client_id=@Client_id";
