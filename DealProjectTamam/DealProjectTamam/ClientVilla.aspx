<%@ Page Title="" Language="C#" MasterPageFile="~/Client1.Master" AutoEventWireup="true" CodeBehind="ClientVilla.aspx.cs" Inherits="DealProjectTamam.ClientVilla" %>
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        <div class="checkbox">
                            ...
                            <label for="ch_price_per_day4">Rs:more than 5000</label>
                        </div>
                    </dd>
                    ...
                    <dd>
                        ...
                        <div class="checkbox">
                            <asp:CheckBox ID="ch_price_per_week1" runat="server" />
                            <label for="ch_price_per_week1">Rs: <1000</label>
                        </div>

                        <div class="checkbox">
                            <asp:CheckBox ID="ch_price_per_week2" runat="server" />
                            <label for="ch_price_per_week2">Rs: <5000</label>
                        </div>

                        <div class="checkbox">
                            <asp:CheckBox ID="ch_price_per_week3" runat="server" />
                            <label for="ch_price_per_week3">Rs: <7500</label>
                        </div>

                        <div class="checkbox">
                            <asp:CheckBox ID="ch_price_per_week4" runat="server" />
                            <label for="ch_price_per_week4">Rs: <10000</label>
                        </div>

                        <div class="checkbox">
                            <asp:CheckBox ID="ch_price_per_week5" runat="server" />
                            <label for="ch_price_per_week5">Rs:10000+</label>
                        </div>
                    </dd>
                    ...
                    <dd>
                        <div class="checkbox">
                            <asp:CheckBox ID="ch_price_per_month1" runat="server" />
                            <label for="ch_price_per_month1">Rs: <3000</label>
                        </div>

                        <div class="checkbox">
                            <asp:CheckBox ID="ch_price_per_month2" runat="server" />
                            <label for="ch_price_per_month2">Rs: <7000</label>
                        </div>

                        <div class="checkbox">
                            <asp:CheckBox ID="ch_price_per_month3" runat="server" />
                            <label for="ch_price_per_month3">Rs: <10000</label>
                        </div>

                        <div class="checkbox">
                            <asp:CheckBox ID="ch_price_per_month4" runat="server" />
                            <label for="ch_price_per_month4">Rs: <20000</label>
                        </div>

                        <div class="checkbox">
                            <asp:CheckBox ID="ch_price_per_month5" runat="server" />
                            <label for="ch_price_per_month5">Rs: <50000</label>
                        </div>

                        <div class="checkbox">
                            <asp:CheckBox ID="ch_price_per_month6" runat="server" />
                            <label for="ch_price_per_month5">Rs:50000+</label>
                        </div>
    ...
    <ItemTemplate>
        <div class="hotel-card">
            <div class="hotel-image">
                <asp:Image ID="Image1" runat="server" ImageUrl='<%# "~/Property/" + Eval("Villa_id") + "/main/" + Eval("Villa_image") %>' CssClass="hotel-img" />
            </div>
            <div class="hotel-info">
                <h3><%# Eval("Villa_name") %></h3>
                <p class="hotel-location"><%# Eval("Villa_town") %>, Rating: <%# Eval("Villa_Rating") %>/5</p>
                <p class="hotel-price">From Rs. <%# Eval("Villa_priceday") %>/day</p>
                 <p class="hotel-price">From Rs. <%# Eval("Villa_priceweek") %>/Week</p>
                 <p class="hotel-price">From Rs. <%# Eval("Villa_pricemonth") %>/month</p>
                <asp:Button ID="Button1" runat="server" CssClass="info-btn" PostBackUrl='<%# "Villa_details.aspx?Parameter="+ Eval("Villa_id") %>' Text="More Info" />
            </div>
        </div>
    </ItemTemplate>
</asp:Repeater>
