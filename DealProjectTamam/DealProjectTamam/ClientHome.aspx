<%@ Page Title="" Language="C#" MasterPageFile="~/Client1.Master" AutoEventWireup="true" CodeBehind="ClientHome.aspx.cs" Inherits="DealProjectTamam.ClientHome" %>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="hp-room-item">
                            ...
                            <div class="hr-text">
                              ...
                              <a href="Clientvilla.aspx" class="primary-btn">More Details</a>
                        ...
                        <div class="hp-room-item">
                            ...
                            <div class="hr-text">
                                ...
                                <table>
                                 ...
                                 <a href="ClientHotel.aspx" class="primary-btn">More Details</a>
                            </div>
                        </div>
                    </div>
                </ItemTemplate>
