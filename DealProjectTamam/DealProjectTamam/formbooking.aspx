<%@ Page Title="" Language="C#" MasterPageFile="~/Client3.Master" AutoEventWireup="true" CodeBehind="formbooking.aspx.cs" Inherits="DealProjectTamam.formbooking" %>
                                    ...
                                    <div class="b-info">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                <th>Villa</th>
                                                <td>
                                                    <asp:Label ID="lbl_villa" runat="server" Text='<%# Eval("Hotel_name") %>'></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Check-in Date</th>
                        ...
                        <div class="card-body">
                            ...
                            <asp:Repeater ID="Repeater1" runat="server">
                                <ItemTemplate>
                                    ...
                                    <div class="actions">
                                        <asp:Button ID="btnBagain" CssClass="btn btn-primary" runat="server" PostBackUrl='<%# "Hotel_Details.aspx?Parameter="+ Eval("Hotel_id") %>' Text="Book again" />
