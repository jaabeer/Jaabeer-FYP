<%@ Page Title="" Language="C#" MasterPageFile="~/Owner.Master" AutoEventWireup="true" CodeBehind="Modify_Villa.aspx.cs" Inherits="DealProjectTamam.Modify_Villa" %>
                ...
                <section class="col-lg-9">
                    <nav class="inner-nav">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link" href="#villa_details" title="Villa Details">Villa Details</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#villa_description" title="Description">Villa Description</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#villa_pictures" title="Pictures">Upload Pictures</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#villa_accessibilities" title="Accessibilities">Villa Accessibilities</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#villa_facilities" title="Facilities">Villa facilities</a>
                            </li>
                        </ul>
                    </nav>
                    <!--villa details-->
                    <section id="villa_details" class="tab-content mt-3">
                        <article>
                            <h2>Villa Details</h2>
                            <fieldset class="border p-4">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <asp:CompareValidator ID="CV_priceday" runat="server" ValidationGroup="VgVillaDetails"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <asp:CompareValidator ID="CV_priceweek" runat="server" ValidationGroup="VgVillaDetails"
                                            ControlToValidate="txtProp_priceweek" CssClass="text-danger" ErrorMessage="Price per week must be greater than zero" Display="Dynamic"
                                            Operator="GreaterThan" Type="Integer"
                                            ValueToCompare="0" />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <asp:CompareValidator ID="CV_pricemonth" runat="server" ValidationGroup="VgVillaDetails"
                                            ControlToValidate="txtProp_pricemonth" CssClass="text-danger" ErrorMessage="Price per month must be greater than zero" Display="Dynamic"
                                            Operator="GreaterThan" Type="Integer"
                                            ValueToCompare="0" />
                                    </div>
                                    <div class="form-group col-md-6">
                                ...
                                <div class="row">
                                    <div class="form-group col-12 text-center">
                                        <asp:Button ID="btnSave_own_loc_price" runat="server" ValidateRequestMode="Enabled"
                                            Text="Save" ValidationGroup="VgVillaDetails" 
                    ...
                    <!--Villa Description-->
                    <section id="villa_description" class="tab-content mt-3">
                        <article>
                    ...
                    <!--Villa Pictures-->
                    <section id="villa_pictures" class="tab-content mt-3">
                        <article class="col-12">

                            <h2>Villa Main Picture</h2>
                        ...
                        <article class="col-12">
                            <h2>Villa Slideshow Pictures</h2>
                            ...
                            <asp:DataList
                                ...
                                <ItemTemplate>
                                    <div class="col-4 mb-4">
                                        <div class="details">
                                            <asp:Image ID="Image1" ImageUrl='<%# "~/Property/" + Eval("Villa_id") + "/" + Eval("Img_name", "{0}") %>' runat="server" Height="150" Width="180" class="img-thumbnail" />
                    ...
                    <!--villa accessibilities-->
                    <section id="villa_accessibilities" class="tab-content mt-3">
                        <article>
                            <h2>Villa Accessibilities</h2>
                                ...
                                <fieldset class="border p-4">
                                    ...
                                    <asp:GridView ID="gvs_2" OnSelectedIndexChanged="gvs_2_SelectedIndexChanged" DataKeyNames="Det_id" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Villa Accessibilities" ControlStyle-ForeColor="Black" HeaderStyle-ForeColor="Black">
                                                <ItemTemplate>
                    ...
                    <!--villa facilities-->
                    <section id="villa_facilities" class="tab-content mt-3">
                        <article>
