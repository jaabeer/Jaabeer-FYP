...
namespace DealProjectTamam
{
    public partial class BookingForm : System.Web.UI.Page
    {
        ...
        String villa_name, villa_address, v_ref, bk_ckin, bk_ckout, bk_status, user_name, bk_cost, bk_date, villa_id;
        ...
        protected void profileData()
        {
            ...
            while (dr.Read())
            {
                ...
                //txtdob.Text = dr["Client_dob"].ToString();
        ...
        protected void HistoryData()
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from tblBooking b, tblVilla v where Bk_state='F' and Show=1 and Client_id=@Client_id and b.Villa_id=v.Villa_id  order by Bk_date DESc";
        ...
        protected void ReviewData()
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "Select * from tblReviews R, tblVilla V where R.Villa_id = V.Villa_id and  R.Client_id=@Client_id  Order By R.Review_Date DESC";
        ...
        protected void OngoingData()
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from tblBooking b, tblVilla v, tblDistrict d where d.Dist_id=v.Dist_id and  Bk_state !='F' and Client_id=@Client_id and b.Villa_id=v.Villa_id  order by Bk_date DESc";
            cmd.Parameters.AddWithValue("@Client_id", Session["client_id"]);
        ...
        protected void btn_PDF_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from tblBooking b, tblVilla v, tblDistrict d where d.Dist_id=v.Dist_id and  Bk_state !='F' and Client_id=@Client_id and b.Villa_id=v.Villa_id   and b.Bk_id=" + booking;
            cmd.Parameters.AddWithValue("@Client_id", Session["client_id"]);
            ...
            while (dr.Read())
            {
                ...
                villa_name = dr["Villa_name"].ToString();
                villa_address = dr["Villa_street"].ToString() + ", " + dr["Villa_town"].ToString() + ", " + dr["Dist_name"].ToString();
                v_ref = dr["Bk_ref"].ToString();
        ...
        void generate_pdf()
        {
            ...
            var title = new Aspose.Pdf.Text.TextFragment("Deal Tamam Villa BOOKING");
            ...
            var venue = new Aspose.Pdf.Text.TextFragment("Venue: " + villa_name);
            ...
            var location = new Aspose.Pdf.Text.TextFragment("Location: " + villa_address);
            ...
            var bookingReference = new Aspose.Pdf.Text.TextFragment("Booking Reference: " + v_ref);
            ...
            string folderPath = Server.MapPath("~/Property/" + villa_id + "/Booking");
            //Check whether Directory (Folder) exists.
            if (!Directory.Exists(folderPath))
            {
                //If Directory (Folder) does not exists. Create it.
            ...
            String filename = "~/Property/" + villa_id + "/Booking/" + v_ref + ".pdf";
