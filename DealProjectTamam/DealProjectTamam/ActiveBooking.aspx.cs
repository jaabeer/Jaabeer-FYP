...
{
    public partial class ActiveBooking : System.Web.UI.Page
    {
        ...
        void get_All_Bookings()
        {
            ...
            cmd.CommandText = "SELECT * from tblClient tc inner join tblBooking tb on tb.Client_id=tc.Client_id inner join tblHotel th on th.Hotel_id=tb.Hotel_id where th.Own_id = " + qs;
            cmd.Connection = con;
        ...
        protected void get_pending()
        {
            ...
            cmd.CommandType = CommandType.Text;
            //cmd.CommandText = "SELECT * from tblClient";
            cmd.CommandText = "SELECT * from tblClient tc inner join tblBooking tb on tb.Client_id=tc.Client_id inner join tblHotel th on th.Hotel_id=tb.Hotel_id where tb.Bk_state ='P' and th.Own_id = " + qs;
            cmd.Connection = con;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            //DataSet ds1 = new DataSet();
        ...
        protected void get_payment()
        {
            ...
            cmd.CommandType = CommandType.Text;
            //cmd.CommandText = "SELECT * from tblClient";
            cmd.CommandText = "SELECT * from tblClient tc inner join tblBooking tb on tb.Client_id=tc.Client_id inner join tblHotel th on th.Hotel_id=tb.Hotel_id where tb.Bk_state ='B' and th.Own_id = " + qs;
            cmd.Connection = con;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            //DataSet ds1 = new DataSet();
        ...
        protected void get_confirm()
        {
            ...
            cmd.CommandType = CommandType.Text;
            //cmd.CommandText = "SELECT * from tblClient";
            cmd.CommandText = "SELECT * from tblClient tc inner join tblBooking tb on tb.Client_id=tc.Client_id inner join tblHotel th on th.Hotel_id=tb.Hotel_id where tb.Bk_state ='C' and th.Own_id = " + qs;
            cmd.Connection = con;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            //DataSet ds1 = new DataSet();
