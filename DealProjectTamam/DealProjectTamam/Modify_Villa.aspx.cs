...
{
    public partial class Modify_Villa : System.Web.UI.Page
    {
        String Villa_name_old;
        String Villa_phone_old;
        String Villa_email_old;
        String Villa_street_old;
        String Villa_town_old;
        String Villa_priceday_old;
        String Villa_priceweek_old;
        String Villa_pricemonth_old;
        String Villa_postcode_old;
        ...
        void Populate_owner_loc_price()
        {
            ...
            while (dr.Read())
            {
                ...
                img_main.ImageUrl = "~/Property/" + qs + "/main/" + dr["Villa_image"].ToString();
            }
        }
        ...
        protected void btnSave_own_loc_price_Click(object sender, EventArgs e)
        {
            ...
            if ((txtProp_name.Text == Villa_name_old)
                && (txtProp_phone.Text == Villa_phone_old)
                && (txtProp_email.Text == Villa_email_old)
                && (txtProp_street.Text == Villa_street_old)
                && (txtProp_town.Text == Villa_town_old)
                && (txtProp_priceday.Text == Villa_priceday_old)
                && (txtProp_priceweek.Text == Villa_priceweek_old)
                && (txtProp_pricemonth.Text == Villa_pricemonth_old)
                && (txtProp_postcode.Text == Villa_postcode_old)
            ...
            else
            {
                ...
                if (dt2 != null)
                {
                    ...
                    if (first_char == "0")
                    {
                        ...
                        {
                            lblResult4.Text = lblResult4.Text + " and cannot start with 0,1";
                        }
                        else
                        {
                            lblResult4.Text = " Phone Number cannot start with 0,1";
                        }
                        ...
                        && (lblResult5.Text.Length == 0) && (lblResult6.Text.Length == 0))
                    {
                        ...
                        con4.Open();
                        cmd4.CommandText = "update tblVilla set Villa_name=@Villa_name, Villa_phone=@Villa_phone, Villa_email=@Villa_email, Villa_street=@Villa_street, Villa_town=@Villa_town, Villa_postcode=@Villa_postcode, Villa_priceday=@Villa_priceday, Villa_priceweek=@Villa_priceweek, Villa_pricemonth=@Villa_month, Dist_id=@Dist_id where Villa_id=" + qs;
                        ...
                        if (IsAdded)
                        {
                            ...
                            lblResult1.Text = "Villa modified";
                            AddNotification();
        ...
        void retrieve_and_store_old_values()
        {
            ...
            while (dr.Read())
            {
                ...
                Villa_name_old = dr["Villa_name"].ToString();
                Villa_phone_old = dr["Villa_phone"].ToString();
                Villa_email_old = dr["Villa_email"].ToString();
                Villa_street_old = dr["Villa_street"].ToString();
                Villa_town_old = dr["Villa_town"].ToString();
                Villa_priceday_old = dr["Villa_priceday"].ToString();
                Villa_priceweek_old = dr["Villa_priceweek"].ToString();
                Villa_pricemonth_old = dr["Villa_pricemonth"].ToString();
                Villa_postcode_old = dr["Villa_postcode"].ToString();
        ...
        protected void Btn_Save_description_Click(object sender, EventArgs e)
        {
            ...
            if (dr.HasRows)
            {
                ...
                else
                {
                    ...
                    if (IsUpdated)
                    {
                        lbl_Prop_Desc.Text = "Villa Description updated";
        ...
        protected void btnUpdate_Add_info_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd0.Parameters.AddWithValue("@Villa_id", qs);
        ...
        protected void AddNotification()
        {
            ...
            //Add DELETE statement to delete the selected category for the above CatID
            cmd2.CommandText = "insert into tblNotification ([Notif_details], [Notif_type], [user_id], [Villa_id], [Notif_date], [State], [Show]) values (@details, @type, @user, @Villa, @date, @state, @show)";
            //Create a parametererized query for CatID
            ...
            cmd2.Parameters.AddWithValue("@Villa", qs);
